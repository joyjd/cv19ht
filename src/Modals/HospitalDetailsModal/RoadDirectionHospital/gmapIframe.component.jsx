...
const GmapIframe = (props) => {
  return <div className='iframe-container' dangerouslySetInnerHTML={{ __html: iframe ? iframe + GoogleCredentials.apiKey + "&origin=" + props.userCords[0] + "," + props.userCords[1] + "&destination=" + props.hospitalCord[0] + "," + props.hospitalCord[1] + "&zoom=6&avoid=tolls|highways' allowfullscreen></iframe>" : "" }} />;
};
